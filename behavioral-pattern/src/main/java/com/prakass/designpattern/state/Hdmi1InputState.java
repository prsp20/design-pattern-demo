 ...
 *
 */
public class Hdmi1InputState extends InputSourceState {

    public Hdmi1InputState(MusicPlayerInputSourceButton button) {
        super(button);
    }

    @Override
    public void pressInputSourceButton() {
        button.setInputSource(new UsbInputState(button));
    }

    @Override
    public String toString() {
        return "HDMI 1 input source";
    }
}
