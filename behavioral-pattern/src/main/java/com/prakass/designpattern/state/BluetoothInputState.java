 ...
 *
 */
public class BluetoothInputState extends InputSourceState {

    public BluetoothInputState(MusicPlayerInputSourceButton button) {
        super(button);
    }

    @Override
    public void pressInputSourceButton() {
        button.setInputSource(new Hdmi1InputState(button));
    }

    @Override
    public String toString() {
        return "Bluetooth input source";
    }
}
